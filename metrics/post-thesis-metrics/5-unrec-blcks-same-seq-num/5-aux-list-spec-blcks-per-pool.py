...
block_height_from = sys.argv[3]
block_height_to = sys.argv[4]
...
blocks = blocks[  (blocks['Number'] >= block_height_from ) & (blocks['Number'] <=  block_height_to ) &
    (blocks['MiningPool'] == pool_name )  ]
